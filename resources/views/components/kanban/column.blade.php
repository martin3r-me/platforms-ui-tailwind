...
<div 
    ...
    @endif
    {{ $attributes->merge(['class' => 'kanban-column flex-shrink-0 h-full flex flex-col', 'style' => 'width:20rem;min-width:20rem']) }}
    ...
    :style="isList ? 'width:100%;min-width:0' : 'width:20rem;min-width:20rem'"
>
