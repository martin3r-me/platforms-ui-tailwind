...
<div class="flex-1 min-h-0 h-full overflow-hidden relative" x-data="{ view: 'board', toggleView() { this.view = this.view === 'board' ? 'list' : 'board'; localStorage.setItem('kanbanView', this.view); console.log('Saved view:', this.view); } }" x-init="this.view = localStorage.getItem('kanbanView') || 'board'; console.log('Loaded view:', this.view);">
    ...
    <div class="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-10">
        <button 
            ...
            :class="view === 'board' ? 'bg-blue-600/90 text-white border-blue-600/90 hover:bg-blue-700/90' : 'bg-white/80 text-gray-800 border-gray-300/80 hover:bg-white/90'"
        >
