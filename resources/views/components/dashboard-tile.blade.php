...
@php
    ...
    $v = in_array($variant, ['primary','secondary','success','danger','warning','info','muted']) ? $variant : 'secondary';
    $variantClasses = [
        'bg' => "bg-[color:var(--ui-{$v}-5)]",
        'border' => "border-[color:var(--ui-{$v}-20)]",
        'text' => "text-[color:var(--ui-{$v})]",
        'hover' => "hover:bg-[color:var(--ui-{$v}-10)]",
        'icon' => "text-[color:var(--ui-{$v})]",
